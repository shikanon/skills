...
COMPARISON_PROMPT = """你是一位专业的 UI 质量保证工程师。请将以下网页视觉分析结果与 UI 需求文档进行对比，找出所有差异。
...
请以 JSON 格式输出：
{
  "differences": [
    {
      "category": "layout/color/typography/component/missing/extra",
      "severity": "critical/major/minor/suggestion",
      "description": "差异描述",
      "expected": "需求期望",
      "actual": "实际表现",
      "fix_suggestion": "修复建议（包含具体的 CSS/HTML 修改建议）"
    }
  ],
  "summary": {
    "critical_count": 0,
