...
### Step 2: 多阶段生成图文Prompt
将选中的案例输入大模型进行分析，采用三阶段生成流程：

**阶段 1：内容策划** - 基于用户输入的主题，策划3个极具爆款潜力的创作方向（如避雷指南、新手保姆级、行业内幕揭秘等），选择最优方向。

**阶段 2：生成标题、文案和标签** - 基于选定的策划方向，生成：
- 标题（15字内，带情绪感/干货感/热点感）
- 文案（口语化，有emoji，开头吸睛，中间分点，结尾引导互动）
- 标签（6-10个相关热门标签）

**阶段 3：生成图片提示词** - 基于生成的文案，生成3张图片的详细描述：
- 第1张：封面图，视觉冲击力强，主体明确
- 第2、3张：信息海报，结构清晰，包含标题区和内容区

⚠️ **重要约束**：图片prompt中绝对不能出现“小红书”字样、Logo或任何提及“小红书”的内容。
